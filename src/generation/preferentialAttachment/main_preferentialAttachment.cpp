...
#include "preferentialAttachment.hpp"
...
int main(int argc, char const *argv[])
{
	...
	desc.add_options()
		...
		("m,m", po::value<std::size_t>(), "Specifies the m parameter.")
		("undirected", po::bool_switch(), "Specifies the m parameter.")
		("directed", po::bool_switch(), "Specifies the m parameter.")
	...
	if(vm["undirected"].as<bool>())
	{
		...
		GraphGeneration::generate_preferential_attachment_undirected(g, n, m, rand_gen);
	...
	if(vm["directed"].as<bool>())
	{
		...
		GraphGeneration::generate_preferential_attachment_directed(g, n, m, rand_gen);
